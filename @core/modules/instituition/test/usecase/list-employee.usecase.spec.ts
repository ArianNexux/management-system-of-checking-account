...
describe("Test suit to list Employee", () => {
    ...
    test('should list an Employee', async () => {
        ...
        expect(output.data[0].id).toBe(employee1.id.value);
        expect(output.data[0].name).toBe(employee1.name.value)
        expect(output.data[0].email).toBe(employee1.email.value)
        ...
        expect(output.data[1].id).toBe(employee2.id.value);
        expect(output.data[1].name).toBe(employee2.name.value)
        expect(output.data[1].email).toBe(employee2.email.value)
